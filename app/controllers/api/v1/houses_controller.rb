class Api::V1::HousesController < ApplicationController
  ...
  def characters
    ...
    render json: @characters.as_json(
      only: %i[id name species gender date_of_birth ancestry eye_colour hair_colour
               patronus hogwarts_student hogwarts_staff
               actor alive image], include: { wand: { only: %i[wood core length] } }
    )
  end
